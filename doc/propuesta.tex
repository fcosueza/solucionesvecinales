...
~\\\\
\-\ \-\ \-\ Nuestro software \textbf{no interactúa directamente} con el \textbf{hardware} en que se va a ejecutar ni el cliente ni el servidor. En el lado del cliente, la forma de interacción será a través del navegador del usuario, mientras que en la parte de servidor será la base de datos y el servidor web quienes se encarguen de interactuar con el SO y este a su vez con el hardware, por lo que no debemos implementar ninguna interfaz específica.
