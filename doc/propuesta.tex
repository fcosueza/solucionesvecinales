...
\begin{itemize}
	...
	\item \textbf{Mensaje}(\uline{fecha, \dashuline{comunidad}}, texto)
	\item \textbf{Zona\_Comun}(\uline{nombre, \dashuline{comunidad}}, descripción, imagen, horario\_inicio, horario\_fin)
	\item \textbf{Incidencia}(\uline{fecha, \dashuline{comunidad, usuario}}, descripción, estado)
\end{itemize}
...
\begin{itemize}
	...
	\item \textbf{reserva}(\uline{\dashuline{usuario, comunidad, zona}}, fecha\_reserva, hora\_inicio, hora\_fin)
\end{itemize} 
