...
\begin{itemize}
	...
	\item \textbf{Usuario}(\underline{correo}, rol, nombre\_usuario, nombre, apellidos, calle, número, piso, letra)
\end{itemize}
...
\begin{itemize}
	\item \textbf{Credenciales}(\uline{\dashuline{correo\_usuario}}, password)
	\item \textbf{Mensaje}(\uline{tiempo\_creacion, \dashuline{comunidad}}, texto)
	\item \textbf{Zona\_Comun}(\uline{nombre, \dashuline{comunidad}}, descripción, imagen, horario\_inicio, horario\_fin)
	\item \textbf{Incidencia}(\uline{fecha\_creacion, \dashuline{comunidad, usuario}}, descripción, estado)
\end{itemize}
...
\begin{itemize}
	\item \textbf{inscripción}(\uline{\dashuline{usuario, comunidad}})
	\item \textbf{solicitud}(\uline{\dashuline{usuario, comunidad}}, estado)
	\item \textbf{reserva}(\uline{\dashuline{usuario, comunidad, nombre\_zona}}, fecha\_reserva, hora\_inicio, hora\_fin)
\end{itemize} 
