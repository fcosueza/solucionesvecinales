...
\paragraph{Interfaces de Hardware}
~\\\\
\-\ \-\ \-\ 
...
\begin{itemize}
	\item \textbf{Barra Superior}: en la barra superior todas las opciones del menú se agruparán en una menú de tipo hamburguesa, el cual se situará en la parte derecha de la barra.
...
Más adelante, en la sección de adecuación al entorno y restricciones de diseño se proporcionará más información sobre el desempeño de la aplicación den dispositivos móviles y tablets.
