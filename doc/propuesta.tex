...
\begin{itemize}
	...
	\item Los usuario usuarios deberán \textbf{ingresar al sistem}a empleando su \textbf{correo y contraseña}, salvo el \textbf{administrador web}, que podrá usar el \textbf{usuario WebAdmin} y su contraseña.
\end{itemize}
...
Para cumplir este calendario de entregas, cualquier \textbf{elemento fuera de estas entregas} se considerá \textbf{fuera del alcance del proyecto}, salvo que su desarrollo sea vital para el correcto funcionamiento de alguno de los elementos especificados en las entregas.
...
\begin{itemize}
	...
	\begin{itemize}
		...
		\item \textbf{Menú Lateral}: un menú lateral, situado a la izquierda, que mostrará los diferentes servicios que ofrece al aplicación para gestionar la comunidad. Las opciones variarán según si el usuario tiene el rol de administrador o de usuario, pero la opciones comunes a ambos son las siguientes: 
		...
		El menú lateral se mostrará solo en caso de que el usuario, independientemente de su rol, este inscrito en una comunidad. En caso contrario no se mostrará. Si el usuario es una \textbf{administrador}, se mostrará en su lugar un \textbf{formulario para añadir una comunidad}. Si es un \textbf{usuario}, se mostrará un \textbf{mensaje con el estado} de su solicitud de suscripción.
		
		\item \textbf{Zona de Contenido}: en esta zona, que estará ubicada en el centro y es el elemento principal de ésta página. Cuando un \textbf{usuario inscrito en una comunidad} acceda a la página principal de comunidad, aquí se mostrar la \textbf{información} de ésta, como nombre, dirección y una imagen. Además, se mostraran la actividad reciente del usuario, así como otros notificaciones, como las reservas realizadas o el estado de las incidencias creadas.
