...
No será necesaria guía de instalación ni de configuración para los usuarios. Nuestros usuarios accederán a la aplicación de forma en línea y podrán utilizarla sin necesidad de realizar ningún tipo de instalación ni configuración.
...
\begin{table}[H]
	\begin{center}
		...
		\begin{tabular}{| p{5cm} | p{10cm} |}
			...
			RNF16.- Cobertura de Tes &  Los test deberán cubrir el 100\% del código desarrollado\\ \hline
		\end{tabular}	
		\egroup
